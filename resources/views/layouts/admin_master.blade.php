            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <div class="p-15 border-bottom">
                                <!-- Sidebar -->
                                <h5 class="font-medium m-b-10 m-t-10">Administrators Management</h5>
                                <div class="custom-control custom-checkbox m-t-10">
                                    <a href="{{ route('users.index') }}"><i class="mdi mdi-account-settings-variant "></i> Admins</a>
                                    <br>
                                    <a href="{{ route('roles.index') }}"><i class="mdi mdi-briefcase-check"></i> Roles</a>
